...
- Prefer specifics over generics: `shouldReturnZero_whenCartIsEmpty` beats `shouldWork_whenValid`.
...
- Multiple unrelated assertions in THEN — one test should verify one concept; split if THEN asserts two different behaviours.
