...
- Stable DTOs that already have hand-written equals/hashCode with business logic — converting silently changes equality semantics.
- Classes below Java 17 target version: don't introduce a language-level incompatibility just to modernize style.
