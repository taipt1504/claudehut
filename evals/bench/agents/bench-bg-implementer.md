---
name: bench-bg-implementer
description: Benchmark-only BACKGROUND worktree agent (background: true). Records start/end epochs around a fixed-duration work block, commits, returns DONE with branch+sha.
